...
def set_model():
    ...
    if model_size:
        ...
        model_mapping = {
            "1.5b": "deepseek-r1:1.5b", # Ajuste ces noms selon tes modèles Ollama
            "7b": "deepseek-r1:7b",
            "8b": "dedeepseek-r1:8b", # A vérifier/compléter
            "14b": "deepseek-r1:14b", # A vérifier/compléter
            "32b": "deepseek-r1:32b", # Ajuste ces noms
            "70b": "deepseek-r1:70b", # Exemple, à ajuster
            "671b": "deepseek-r1:671b", # A vérifier/compléter
        }
